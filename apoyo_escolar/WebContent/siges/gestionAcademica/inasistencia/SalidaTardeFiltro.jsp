...
<caption>Filtro de salida tarde</caption>
...
<input type="hidden" name="tipo" value='<c:out value="${paramsVO.FICHA_SALIDA_TARDE}"/>'>
...
<table cellpadding="0" cellspacing="0" border="0" ALIGN="CENTER" width="100%" >
	<tr height="1">
		...
		<td width="600" bgcolor="#FFFFFF">
			...
			<img src='<c:url value="/etc/img/tabs/salida_tarde_1.gif"/>' alt="-Salida tarde-" width="84"  height="26" border="0">
		</td>
		</tr>
	</table>
