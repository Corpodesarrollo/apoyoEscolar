...
<body onLoad="mensaje(document.getElementById('msg'));">
		...
		<input type="hidden" name="tipo" value='<c:out value="${ paramsVO.FICHA_REP_LOGROS_GRADO}"/>'>
		  ...
		  <caption>Gestión Académica >> Reportes Estadísticos </caption>
	        <tr height="1">
				...
				<p align="center" class="sombran">Evaluación Tipo <c:out value="${logdes[1]}"/></p>
			        ...
			        <td width="14%" height="26"><img src='<c:url value="/etc/img/tabs/Evaluacion_LogroGrado_1.gif"/>' width="84" height="26" border="0"></td>
