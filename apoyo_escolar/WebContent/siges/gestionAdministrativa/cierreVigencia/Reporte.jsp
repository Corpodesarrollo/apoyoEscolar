...
JasperPrint jasperPrint = JasperFillManager.fillReport(context.getRealPath("/")+"siges/gestionAdministrativa/cierreVigencia/reportes/cierrevigenciadet.jasper", parametros,conn);
