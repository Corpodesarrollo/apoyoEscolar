...
<head>
<title>Sistema de Apoyo Escolar - Selección Colegios.</title>
...
var numChecks=0;
	...
	function enviar(){
		...
		opener.document.frmNuevo.instCodigos.value=codigosAsig; 		
		opener.document.frmNuevo.instNombres.value=abrevAsig;
...
<body onLoad="mensaje(document.getElementById('msg'));">
	<form method="post" name="frmAsig"'>
		...
		<table border="0" align="center" width="95%" cellpadding="0" cellspacing="0">
			...
			<caption>Seleccionar Colegios</caption>
		
		 	
		 	<c:if test="${empty requestScope.listaColegios2}">		 					
				<tr><th class="Fila1" colspan='6'>NO EXISTEN REGISTROS DE COLEGIOS</th></tr>				
			</c:if>
			<c:if test="${!empty requestScope.listaColegios2}">
				<tr>
					<th width='30' class="EncabezadoColumna">&nbsp;</th>
					<th class="EncabezadoColumna">Colegio</td>
					
				</tr>
				<c:forEach begin="0" items="${requestScope.listaColegios2}" var="lista" varStatus="st">
					<tr>
