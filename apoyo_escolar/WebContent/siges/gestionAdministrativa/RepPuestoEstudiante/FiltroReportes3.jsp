...
<body onLoad="mensaje(document.getElementById('msg'));">
			...
			<input type="hidden" name="tipo" value='<c:out value="${ paramsVO.FICHA_REPORTES3}"/>'>
   ...
   <!-- FORMUALARIO DE EDICION CREACION--> 		  
	<form method="post" name="frmNuevo"  action='<c:url value="/siges/gestionAdministrativa/RepPuestoEstudiante/Save.jsp"/>'>
		...
		<input type="hidden" name="tipoReporte" value='3'>
		...
		<input type="hidden" name="valorFin_" value='100'>
		 ...
		 <table cellpadding="0" cellspacing="1" border="0" ALIGN="CENTER" width="100%" >
		  <caption>Gestión Administrativa >> Reporte Puesto Áreas</caption>	         
		    <tr>						
			 <td rowspan="2" bgcolor="#FFFFFF">			      
				   ...
				   <img src='<c:url value="/etc/img/tabs/reportes/puestoArea_1.gif"/>' border="0"  height="26" alt='Reporte puesto área'>
		 	 ...
		 	 <tr><td><span class="style2" ></span>Metodología</td>
		 	  ...
		 	  <tr>
		 	    ...
		 	    <td><a href='javaScript:ajaxAsig();'>
								<img border='0' src='<c:url value="/etc/img/todas.gif"/>' width='18' height='18' alt="Seleccionar Asignaturas">
					 </a>
		 	    </td>
		 	 </tr>   
		 	 <tr><!-- <td colspan="1" >Áreas(s) / Asignatura(s)</td> -->
		 	    <td colspan="4">
		 	    <textarea name="asigNombres" id="asigNombres"  cols="78" row="2" value='<c:out value="${sessionScope.filtroReportesVO.asigNombres}"/>' readonly="true"></textarea>	
