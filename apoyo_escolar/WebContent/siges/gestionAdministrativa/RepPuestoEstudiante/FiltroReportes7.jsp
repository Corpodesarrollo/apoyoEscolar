...
<body onLoad="mensaje(document.getElementById('msg'));">
   ...
   <!-- FORMUALARIO DE EDICION CREACION--> 		  
		  ...
		  <caption>Gestión Administrativa >> Reporte Liatado Inasistencia</caption>	         
		    <tr>						
			 <td rowspan="2" bgcolor="#FFFFFF">			      
				   ...
				   <img src='<c:url value="/etc/img/tabs/reportes/ResumenInas_1.gif"/>' border="0"  height="26" alt='Reporte resumen Inasistencia'>
		        </td>
            </tr>
          </table>
	...
	<div id="rep1" style="display:">
		  ...
		  <tr><td style="width: 15%"><span class="style2" >*</span>Tipo Reporte</td>
		 	    <td style="width: 35%"><select  name="tipoReporte" id="tipoReporte" style="width: 300px;" onchange="JavaScript:cambioAsignaturas();">
		   ...
		   <!-- <tr><td style="width: 15%"><span class="style2" >*</span>Vigencia</td>
			...
			<tr>
		 	...
		 	<tr>
		 	    ...
		 	    <td style="width: 35%" ><select name="inst" id="inst" style="width: 300px;" <c:if test="${sessionScope.filtroReportesVO.hab_inst ==0}">DISABLED</c:if> >
		 	        <option value="-9">-- Seleccione uno--</option>
