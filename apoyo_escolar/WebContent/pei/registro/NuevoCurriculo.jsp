...
<html>
<head>
<SCRIPT language=javascript src='<c:url value="/pei/registro/NuevoCurriculo.js"/>'></SCRIPT>
<script language="javaScript">var nav4=window.Event ? true : false;</script>
</head>
<c:import url="/mensaje.jsp"/>
<body onLoad="mensaje(document.getElementById('msg'));">
	<form method="post" name="frmNuevo" onSubmit="return validarForma(frmNuevo)" action='<c:url value="/pei/registro/SaveCurriculo.jsp"></c:url>'>
		...
		<table border="0" align="center" bordercolor="#FFFFFF" width="95%">
		  ...
		  <table border="0" align="center" width="95%" cellpadding="1" cellspacing="0">
			<tr>
				...
				<td>
				<textarea name="curAlcance" rows="2" cols="40" onKeyDown="textCounter(this,300,300);" onKeyUp="textCounter(this,300,300);"><c:out value="${sessionScope.curriculoPEIVO.curAlcance}"/></textarea>				
				</td>
			</tr>	
			<tr>
				<td><span class="style2">*</span> Dificultad:</td>
				<td>
				<textarea name="curDificultad" rows="2" cols="40" onKeyDown="textCounter(this,300,300);" onKeyUp="textCounter(this,300,300);"><c:out value="${sessionScope.curriculoPEIVO.curDificultad}"/></textarea>				
				</td>
			</tr>	
		</table>
	</form>
