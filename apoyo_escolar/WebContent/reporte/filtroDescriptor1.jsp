								...
								<TABLE width="100%" cellpadding="3" cellSpacing="0">
									<tr>
										<td><span class="style2"></span><font size=1><p align='justify'>
											Muestra para cada fortaleza de un área el número y porcentaje de estudiantes que la tienen. 
											...
											Mostrar un cuadro: filas: el nombre de cada fortaleza, columnas: 1 - Nº de estudiantes que la presentan, 2 - % contra el total.
										</p></font></td>
									</tr>
									<tr>
										<td>&nbsp;</td>
