				...
				if(validarForma(document.frm)){
					...
					document.frm.cmd.value="Buscar";
					 ...
					 if(document.frm.formatoCarne_[0].checked == true){
					   document.frm.formatoCarne.value = 11; //Un carne por hoja
					 }else if(document.frm.formatoCarne_[1].checked == true){
					   document.frm.formatoCarne.value = 12; //Varios carne por hoja (carta)
					 }else{
					   document.frm.formatoCarne.value = 13; //Varios carne por hoja (Oficio)
					 }
...
<!--//////////////////-->	
	...
	<table border="0" align="center" width="100%">
		<tr height="1">
			<td rowspan="2" width="420" bgcolor="#FFFFFF"><a href="javaScript:lanzar(1)"><img src="../etc/img/tabs/carnes_est_0.gif" alt="Generaci&oacute;n de Carnés" width="84"  height="26" border="0"></a><img src="../etc/img/tabs/carnes_adm_doc_1.gif" alt="Administrativos y docentes" width="84"  height="26" border="0"></td>
		</tr>
  </table>
  
  <TABLE width="100%" cellpadding="3" cellSpacing="0">
		<tr><td colspan="4" class="Fila0"   align="center">Formato de Carne Administrativos y Docentes</td></tr>
								...
								<TABLE width="100%" cellpadding="3" cellSpacing="0">
									  ...
									  <tr>
										  <td colspan='4'>
											...
											Si necesita generar el carné de una sola persona, por favor ingrese el número de identificación del administrativo o docente en el siguiente campo; de lo contrario, no lo diligencie.
											</b>
											</span>
											</td>
									  </tr>
