...
//Variable que almacenarñ la posiciñn del scroll, por defecto tiene valor 0.
var scrollCachePosition = 0;

$(function() {
	$("#abrirPop").click(function(event) {
		scrollCachePosition = $(window).scrollTop();
		//Envño el scroll a la posiciñn 0 (left), 0 (top), es decir, arriba de todo.
		...
		//Si la capa 'wrapper' es mñs grande que el body incrementa la altura de la capa 'wrapper' a la capa 'capaPopUp'.
	...
	$("#cerrar").click(function(event) {
		...
		$("#capaPopUp").slideToggle();
		$("#popUpDiv").slideToggle();
		//Si la variable scrollCachePosition es mayor que 0 incrementarñ la posiciñn del scroll al valor que se almacenñ. 
