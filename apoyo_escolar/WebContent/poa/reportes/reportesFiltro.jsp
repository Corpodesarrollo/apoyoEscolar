...
<html>
		...
		<script language="javaScript">
			...
			<!--
				...
				function hacerValidaciones_frmFiltro(forma) {
					...
					if(parseInt(forma.filTipoReporte.value)==50) {
					...
					if(parseInt(forma.filTipoReporte.value)==53) {
					...
					if(parseInt(forma.filTipoReporte.value) == 60) {			// Reporte General Consolidado Institución
				...
				function cambioReporte() {
					...
					if(parseInt(document.frmFiltro.filTipoReporte.value) > 0) {
						...
						if(parseInt(document.frmFiltro.filTipoReporte.value) == 50) {
							...
							document.frmFiltro.filObjetivo.value="-99";
						...
						} else if(parseInt(document.frmFiltro.filTipoReporte.value) == 53) {
							...
							document.frmFiltro.filPorEjec1.disabled=true;
							document.frmFiltro.filPorEjec2.disabled=true;
							document.frmFiltro.filObjetivo.disabled=false;
				...
				function cambioReporteGenerado() {
					...
					if(parseInt(document.frmFiltro.filTipoReporte.value) > 0) {
						...
						} else if(parseInt(document.frmFiltro.filTipoReporte.value) == 61) {
				...
				function actualizarPeriodos() {
					...
					// Se envía un valor que no se encuentre programado en el switch de tal forma que no se actualicen todos los valores del filtro
	...
	<body onLoad="mensaje(document.getElementById('msg'));">
		...
		<form action='<c:url value="/poa/reportes/Save.jsp"/>' method="post" name="frmFiltro" onSubmit="return validarForma(frmFiltro)">
			...
			<input type="hidden" name="filLocalidad" value='<c:out value="${sessionScope.login.munId}"/>'>
			...
			<table cellpadding="0" cellspacing="0" border="0" ALIGN="CENTER" width="100%" >
				<tr height="1">
					...
					<td rowspan="2" width="469">
						<img src='<c:url value="/etc/img/tabs/poa_reportes_1.gif"/>' alt="Consulta" height="26" border="0">
					</td>
				</tr>
			</table>
				...
				<tr>
					<td>
						<c:if test="${sessionScope.NivelPermiso==2}">
	   				 	...
	   				 	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span align="left" id="txtmsg" name="txtmsg" style="font-weight:bold;font-size:10pt;color: #FF6666"> </span>
	   				 	<span align="left" id="barraCargar" name="barraCargar" style="font-weight:bold;font-size:9pt;color: #FF6666"> </span>
			  		</td>
			 	</tr>	
			</table>
			...
			<table border="0" align="center" width="95%">
				<tr>
					...
					<td>
						<select name="filTipoReporte" onchange="cambioReporte();" style="width:280px">
				...
				<tr>
					...
					<td>
						<select name="filVigencia" onchange="actualizarPeriodos();cambioReporte()" style="width:180px">
							<option value="-99" selected>-Seleccione uno-</option>
				...
				<tr>
					...
					<td>
						<select name="filObjetivo" id="filObjetivo" style="width:500px">
							<option value="-99" selected>-Seleccione uno-</option>
				...
				<tr>
					<td> Colegio:</td>
					<td>
						<select name="filInstitucion" style="width:300px" disabled="true" >
							<option value="-99" selected>-Seleccione uno-</option>
				...
				-->
			  	...
			  	<tr>
					...
					<td>
						<select name="filAreaGestion" style="width:500px" onchange="javaScript:ajaxLineas();">
							<option value="-99" selected>-Seleccione uno-</option>
				...
				<tr>
					...
					<td>
						<select name="filLineaAccion" style="width:500px" disabled="true">
							<option value="-99" selected>-Seleccione uno-</option>
				...
				<!--  
				<tr>
					<td width="125">Fuente Financiación:</td>
					<td>
						<select name="filFteFin" style="width:170px" disabled="true">
							<option value="-99" selected>-Seleccione uno-</option>
				...
				<tr id="por_ejecucion">
					<td width="125px">% de Ejecución:</td>
					<td>
