...
<html>
		...
		<!--
			...
			function cambioReporte() {
				...
				if(parseInt(document.frmFiltro.filTipoReporte.value) > 0) {
					...
					} else if(parseInt(document.frmFiltro.filTipoReporte.value)==54) {				// Consulta General de Necesidades
			...
			function cambioReporteGenerado() {
				...
				if(parseInt(document.frmFiltro.filTipoReporte.value) > 0) {
					...
					} else if(parseInt(document.frmFiltro.filTipoReporte.value)==56) {
					...
					} else if(parseInt(document.frmFiltro.filTipoReporte.value)==57) {
			...
			function imprimir() {
				if(validarForma(document.frmFiltro)) {
					document.frmFiltro.cmd.value = document.frmFiltro.BUSCAR2.value;
					document.frmFiltro.submit();
				}
			}
	...
	<body onLoad="mensaje(document.getElementById('msg'));">
		...
		<form action='<c:url value="/poa/reportes/Save.jsp"/>' method="post" name="frmFiltro" onSubmit="return validarForma(frmFiltro)">
			...
			<input type="hidden" name="BUSCAR2" value='<c:out value="${paramsVO.CMD_BUSCAR2}"/>'>
			...
			<table border="0" align="center" width="95%">
				...
				<tr>
					...
					<td>
						<select name="filVigencia" style="width:180px" onchange="javaScript:ajaxColegio();actualizarPeriodos()">
							<option value="-99" selected>-Seleccione uno-</option>
				...
				<tr>
					<td> Colegio:</td>
					<td>
						<select name="filInstitucion" style="width:500px" disabled="true" >
							<option value="-99" selected>-Seleccione uno-</option>
			 	...
			 	<tr>
					...
					<td>
						<select name="filAreaGestion" style="width:500px" onchange="javaScript:ajaxLineas();" disabled="true">
							<option value="-99" selected>-Seleccione uno-</option>
