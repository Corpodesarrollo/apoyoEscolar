...
<jsp:useBean id="nuevoInfluencia" class="siges.conflicto.beans.InfluenciaConflictos" scope="session"/>
...
<%pageContext.setAttribute("filtroPeriodo",Recursos.recursoEstatico[Recursos.PERIODO]);%>
	...
	<font size="1">
		...
		<table border="1" align="center" bordercolor="#FFFFFF" width="100%">
	        ...
	        <input class='boton' name="cmd1" type="button" value="Buscar" onClick="buscar(50,5)">
        <c:if test="${(sessionScope.nuevoConflicto.ceperiodo!='-1') && (sessionScope.nuevoConflicto.cesede!='-1') && (sessionScope.nuevoConflicto.cejornada!='-1')}">
        	<c:if test="${requestScope.sololectura!=1}">
	      	  <input class='boton' name="cmd1" type="button" value="Guardar" onClick="guardar(51,5)">
	      	 </c:if>
        </c:if>
				</td> 
			</tr>		
		...
		<table cellpadding="0" cellspacing="0" border="0" ALIGN="CENTER" width="100%" >
			<tr height="1">
				...
				<td rowspan="2" width="600" bgcolor="#FFFFFF">
					...
					<img src="../etc/img/tabs/influencia_conflictos_1.gif" alt="Como influyen los conflictos en los siguientes aspectos de la vida del colegio" border="0"  height="26">
	...
	<c:if test="${(sessionScope.nuevoConflicto.ceperiodo!='-1') && (sessionScope.nuevoConflicto.cesede!='-1') && (sessionScope.nuevoConflicto.cejornada!='-1')}">
		<TABLE width="90%" align="center" cellpadding="0" cellSpacing="0" border="0">
			<tr>
				<th class="caption" colspan="2">Como inciden los conflictos en los siguientes aspectos de la vida del colegio</th>
			</tr>
			<c:forEach begin="0" items="${requestScope.filtroCat}" var="fila2">
				<tr>
					...
					<td align="center"><textarea name="d<c:out value="${fila2[0]}"/>" rows="4" cols="85"></textarea></td>
				</tr>
			</c:forEach>
			<tr><td></td></tr>
		</table>
...
<script>
	...
	<c:if test="${(sessionScope.nuevoConflicto.ceperiodo!='-1') && (sessionScope.nuevoConflicto.cesede!='-1') && (sessionScope.nuevoConflicto.cejornada!='-1')}">
		<c:forEach begin="0" items="${sessionScope.nuevoInfluencia.inftexto}" var="fila">
