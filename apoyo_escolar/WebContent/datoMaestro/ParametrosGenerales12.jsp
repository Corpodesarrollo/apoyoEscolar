...
<!--//////////////////-->		
	...
	<table cellpadding="0" cellspacing="0" border="0" width="100%">
		...
		<!-- FIN DE FICHAS A MOSTRAR AL USUARIO -->
								...
								<tr>
									<TD>
 									<iframe id="uno" name="1" marginheight="0" marginwidth="0"  frameborder="NO"  width="100%" src='<c:url value="/datoMaestro/DatoMaestroListaEdit.do?ext=1"/>' valign="top" ALIGN="center" height="800px"></iframe> 
								</TD></TR>
								</TABLE>
	</font>		
</form>
