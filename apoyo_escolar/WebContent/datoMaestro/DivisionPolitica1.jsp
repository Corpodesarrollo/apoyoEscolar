...
<!--//////////////////-->		
	...
	<table cellpadding="0" cellspacing="0" border="0" ALIGN="CENTER" width="100%" bgcolor="#F6F6F6">
			<tr height="1">
				...
				<td rowspan="2" width="780" bgcolor="#FFFFFF"><a href="javaScript:lanzar(3)"><img src="../etc/img/tabs/departamentos_0.gif" alt="Departamentos"  height="26" border="0"></a><img src="../etc/img/tabs/localidad_1.gif" alt="Localidades"  height="26" border="0"></td>
			</tr>
  </table>
