...
<!--//////////////////-->		
	...
	<table cellpadding="0" cellspacing="0" border="0" width="100%">
			<tr height="1">
				...
				<td  width="650px" rowspan="2" bgcolor="#FFFFFF"><a href="javaScript:lanzar(2)"><img src="../etc/img/tabs/tipos_documento_0.gif" alt="Tipos de documento"  height="26" border="0"></a><a href="javaScript:lanzar(25)"><img src="../etc/img/tabs/tipos_propiedad_0.gif" alt="Tipos de Propiedad"  height="26" border="0"></a><a href="javaScript:lanzar(6)"><img src="../etc/img/tabs/tipos_espacio_fisico_0.gif" alt="Tipos de Espacio F&iacute;sico"  height="26" border="0"></a><a href="javaScript:lanzar(11)"><img src="../etc/img/tabs/tipos_ocupantes_0.gif" alt="Tipos de Ocupante"  height="26" border="0" usemap="#ipoi"></a><a href="javaScript:lanzar(19)"><img src="../etc/img/tabs/tipos_programa_0.gif" alt="Tipos de Programas"  height="26" border="0"></a><a href="javaScript:lanzar(8)"><img src="../etc/img/tabs/tipos_reconocimiento_0.gif" alt="Tipos de Reconocimiento"  height="26" border="0"></a><a href="javaScript:lanzar(14)"><img src="../etc/img/tabs/tipos_convivencia_0.gif" alt="Tipos de Convivencia"  height="26" border="0"></a><a href="javaScript:lanzar(18)"><img src="../etc/img/tabs/motivos_ausencia_0.gif" alt="Motivos de Ausencia"  height="26" border="0"></a><img src="../etc/img/tabs/etnias_1.gif" alt="Etnias"  height="26" border="0"><a href="javaScript:lanzar(13)"><img src="../etc/img/tabs/condiciones_0.gif" alt="Condici&oacute;nes"  height="26" border="0"></a><a href="javaScript:lanzar(44)"><img src="../etc/img/tabs/rango_tarifa_0.gif" alt="Rangos de Tarifa"  height="26" border="0"></a><a href="javaScript:lanzar(47)"><img src="../etc/img/tabs/cargo_gobierno_escolar_0.gif" alt="Cargos de Gobierno Escolar"  height="26" border="0"></a><a href="javaScript:lanzar(43)"><img src="../etc/img/tabs/tipo_escala_valorativa_0.gif" alt="Tipos de Escala Valorativa"  height="26" border="0"></a><a href="javaScript:lanzar(43)"><a href="javaScript:lanzar(43)"><a href="javaScript:lanzar(50)"><img src="../etc/img/tabs/tipos_receso_0.gif" alt="Tipos de Receso"  height="26" border="0"></a><a href="javaScript:lanzar(49)"><img src="../etc/img/tabs/tipos_atencion_especial_0.gif" alt="Tipos de Atención Especial"  height="26" border="0"></a><a href="javaScript:lanzar(65)"><img src="../etc/img/tabs/calendario_0.gif" alt="Calendario"  height="26" border="0"></a></td>
			</tr>
  </table>
