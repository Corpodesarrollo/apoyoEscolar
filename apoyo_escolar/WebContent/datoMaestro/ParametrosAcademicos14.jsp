...
<!--//////////////////-->		
	...
	<table cellpadding="0" cellspacing="0" border="0" width="100%">
			<tr height="1">
				...
				<td  width="650px" rowspan="2" bgcolor="#FFFFFF"><a href="javaScript:lanzar(12)"><img src="../etc/img/tabs/especialidad_0.gif" alt="Especialidades"  height="26" border="0"></a><a href="javaScript:lanzar(26)"><img src="../etc/img/tabs/discapacidad_institucion_0.gif" alt="Discapacidad Instituci&oacute;n"  height="26" border="0"></a><a href="javaScript:lanzar(15)"><img src="../etc/img/tabs/discapacidad_estudiante_0.gif" alt="Discapacidad Estudiante"  height="26" border="0"></a><a href="javaScript:lanzar(17)"><img src="../etc/img/tabs/etnias_0.gif" alt="Etnias"  height="26" border="0"></a><a href="javaScript:lanzar(16)"><img src="../etc/img/tabs/capacidades_excepcionales_0.gif" alt="Capacidades Excepcionales"  height="26" border="0"></a><a href="javaScript:lanzar(13)"><img src="../etc/img/tabs/condiciones_0.gif" alt="Condici&oacute;nes"  height="26" border="0"></a><a href="javaScript:lanzar(44)"><img src="../etc/img/tabs/rango_tarifa_0.gif" alt="Rangos de Tarifa"  height="26" border="0"></a><img src="../etc/img/tabs/asociaciones_privadas_1.gif" alt="Asociaciones Privadas"  height="26" border="0"><a href="javaScript:lanzar(47)"><img src="../etc/img/tabs/cargo_gobierno_escolar_0.gif" alt="Cargos de Gobierno Escolar"  height="26" border="0"></a></td>
			</tr>
  </table>
