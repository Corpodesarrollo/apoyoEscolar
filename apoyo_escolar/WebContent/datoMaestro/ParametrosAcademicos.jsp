...
<!--	<input type="hidden" name="tipo2" value='<c:out value="${pageScope.tip}"/>'>-->
	...
	<table cellpadding="0" cellspacing="0" border="0" width="100%">
			<tr height="1">
				...
				<td  width="650px" rowspan="2" bgcolor="#FFFFFF"><img src="../etc/img/tabs/areas_1.gif" alt="&Aacute;reas"  height="26" border="0"><a href="javaScript:lanzar(29)"><img src="../etc/img/tabs/asignatura_0.gif" alt="Asignaturas"  height="26" border="0"></a><a href="javaScript:lanzar(1)"><img src="../etc/img/tabs/jornada_0.gif" alt="Jornadas"  height="26" border="0"></a><a href="javaScript:lanzar(4)"><img src="../etc/img/tabs/nivel_0.gif" alt="Niveles"  height="26" border="0"></a><a href="javaScript:lanzar(23)"><img src="../etc/img/tabs/grados_0.gif" alt="Grados"  height="26" border="0"></a><a href="javaScript:lanzar(24)"><img src="../etc/img/tabs/calendario_0.gif" alt="Calendarios"  height="26" border="0"></a><a href="javaScript:lanzar(9)"><img src="../etc/img/tabs/metodologia_0.gif" alt="Metodolog&iacute;as"  height="26" border="0"></a><a href="javaScript:lanzar(46)"><img src="../etc/img/tabs/idiomas_0.gif" alt="Idiomas"  height="26" border="0"></a><a href="javaScript:lanzar(42)"><img src="../etc/img/tabs/escalas_valorativas_0.gif" alt="Escalas Valorativas"  height="26" border="0"></a><a href="javaScript:lanzar(12)"><img src="../etc/img/tabs/especialidad_0.gif" alt="Especialidades"  height="26" border="0"></a><a href="javaScript:lanzar(53)"><img src="../etc/img/tabs/tipos_enfasis_0.gif" alt="Tipos de Énfasis"  height="26" border="0"></a><a href="javaScript:lanzar(52)"><img src="../etc/img/tabs/tipos_modalidad_0.gif" alt="Tipos de Modalidad"  height="26" border="0"></a><a href="javaScript:lanzar(51)"><img src="../etc/img/tabs/tipos_especialidad_0.gif" alt="Tipos de Especialidad"  height="26" border="0"></a><a href="javaScript:lanzar_(1)"><img src='<c:url value="/etc/img/tabs/adm_nivelEval_0.gif"/>' alt="Nivel Evaluación"  height="26" border="0"></a>
