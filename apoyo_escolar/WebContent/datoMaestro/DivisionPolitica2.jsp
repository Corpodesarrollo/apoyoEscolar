...
<!--//////////////////-->		
	...
	<table cellpadding="0" cellspacing="0" border="0" ALIGN="CENTER" width="100%" bgcolor="#F6F6F6">
			<tr height="1">
				...
				<td rowspan="2" width="780" bgcolor="#FFFFFF"><a href="javaScript:lanzar(3)"><img src="../etc/img/tabs/departamentos_0.gif" alt="Departamentos"  height="26" border="0"></a><a href="javaScript:lanzar(21)"><img src="../etc/img/tabs/localidades_0.gif" alt="Localidades"  height="26" border="0"></a></td>
			</tr>
  </table>
		<!-- FIN DE FICHAS A MOSTRAR AL USUARIO -->
						<TABLE width="100%" cellpadding="3" cellSpacing="0" bgcolor="#F6F6F6">
							<tr>
								<TD>
