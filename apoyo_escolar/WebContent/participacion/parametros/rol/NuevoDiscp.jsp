...
<script languaje="javaScript">
	...
	function hacerValidaciones_frmNuevo(forma){
		...
		validarCampo(forma.tipos , "- Tipo ", 1, 150)
	}
</script>
</head>
	...
	<table width="100%" border="0" cellspacing="0" cellpadding="0">
		<tr><td width="100%" valign='top'>
			<div style="width:100%;height:150px;overflow:auto;vertical-align:top;background-color:#ffffff;">
				<c:import url="/participacion/parametros/Lista.do?tipo=5"/>
			</div>
		</td></tr>
	</table>
		...
		<table border="0" align="center" bordercolor="#FFFFFF" width="100%">
		  ...
		  <table width="100%" border="0" cellspacing="2" cellpadding="2">
				<tr>
					...
					<td>
						<input type="text" name="codigo" maxlength="3" size="3" onKeyPress='return acepteNumeros(event)' value='<c:out value="${sessionScope.rolVO.codigo}"/>'></input>
					</td>
				</tr>
				<tr>
					<td>
						<span class="style2">*</span><b>Nombre de discapacidad</b>
					</td>
					<td>
						<input type="text" name="nombre" maxlength="60" size="50"  value='<c:out value="${sessionScope.rolVO.nombre}"/>'></input>
					</td>
				</tr>
					<tr>
					<td>
						<span class="style2">*</span><b>Tipo</b>
					</td>
					<td>
					<input type="text" name="tipos" maxlength="1" size="2" onKeyPress='return acepteNumeros(event)' value='<c:out value="${sessionScope.rolVO.tipos}"/>'></input>
					</td>
				</tr>
				<tr>
					<td>
					...
					<td>
						<textarea name="descripcion" cols="47" rows="2" onKeyDown="textCounter(this.form.texto,4000,4000);" onKeyUp="textCounter(this.form.texto,4000,4000);"><c:out value="${sessionScope.rolVO.descripcion}"/></textarea>
					</td>
				</tr>
