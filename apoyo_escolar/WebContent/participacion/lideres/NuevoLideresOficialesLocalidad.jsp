...
<body onLoad="mensaje(document.getElementById('msg'));">
	...
	<form method="post" name="frmNuevo" action='<c:url value="/participacion/lideres/SaveLideres.jsp"/>'>
	  ...
	  <table border="0" align="center" width="95%" cellpadding="1" cellspacing="0">
		  <caption>Ingreso / Edición de lideres oficiales localidad</caption>
				<tr>
			...
			<c:if test="${requestScope.porEstudiante=='true'}">
			 	<tr>
				 	...
				 	<tr>
						...
						<td colspan="3">
							<select name="lidGrado" onchange="javaScript:ajaxGrupo()" style="width:300px;" >
								<option value="-99" selected>-Seleccione uno-</option>
				 	...
				 	<tr>
						...
						<td colspan="3">
							<select name="lidGrupo" onchange="javaScript:ajaxEstudiante()" style="width:300px;" >
								<option value="-99" selected>-Seleccione uno-</option>
