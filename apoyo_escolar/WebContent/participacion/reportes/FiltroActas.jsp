...
<body onLoad="mensaje(document.getElementById('msg'));">
	...
	<form action='<c:url value="/participacion/reportes/Save.jsp"/>' method="post" name="frmFiltro">
		...
		<table border="0" align="center" width="95%" cellpadding="0" cellspacing="0" bordercolor="gray">
			...
			<tr><th class="Fila1" colspan='6' align="left"><a href='javaScript:generaReporte();'><img border='0' src="../../etc/img/xls.gif" width='15' height='15'></a> Reporte Listado de Actas de Caracterización</th></tr>
		</table><br>
		 <table border="1" align="center" width="95%" cellpadding="0" cellspacing="0" bordercolor="gray">
				...
				<tr>		
					...
					<td class="EncabezadoColumna" align="center">Fecha<br>Elaboración</td>
