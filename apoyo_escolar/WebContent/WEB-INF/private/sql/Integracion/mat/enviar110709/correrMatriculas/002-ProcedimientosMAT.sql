   ...
   PROCEDURE deleteSede(
	...
	END deleteSede;
	 ...
	 BEGIN
		...
		IF anhovig=anhoreal THEN
			...
			INSERT INTO NOTAS_INTEGRACION (ID,CATEGORIA, FUNCION, P1, P2, P3, P4, P5, P6, P7, P8, P9, P10, P11, P12) VALUES (
			 id_Notas_integracion.NEXTVAL,
			 7,
			 5,
			 codigo,
    ...
    BEGIN
		...
		IF anhovig=anhoreal THEN  
			...
			--insertar el registro realmente a la tabla NOTAS_INTEGRACION
			cont:=0;
			SELECT COUNT(AL_CODI_ID) INTO cont FROM ALUMNO_TEMP WHERE AL_CODI_ID=codigo;
			IF cont=0 THEN
			   --es para insercion de nuevo estudiante    
				...
				id_Notas_integracion.NEXTVAL);
			ELSE
			--Es para actualizacion de estudiante
				IF anhovig=anhoreal THEN
					--insertar el registro realmente a la tabla NOTAS_INTEGRACION    
					INSERT INTO NOTAS_INTEGRACION (ID,CATEGORIA, FUNCION, P1, P2, P3, P4, P5, P6, P7, P8, P9, P10, P11, P12) VALUES (
					 id_Notas_integracion.NEXTVAL,
