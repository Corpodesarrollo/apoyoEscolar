...
drop TABLE NOTAS_INTEGRACION cascade constraints;
...
CREATE OR REPLACE VIEW NOTAS_INTEGRACION_
(ID, CATEGORIA, FUNCION, ESTADO, FECHA, 
 P1, P2, P3, P4, P5, 
 P6, P7, P8, P9, P10, 
 P11, P12, P13, P14, P15, 
 P16, P17, P18, P19, P20, 
...
CREATE OR REPLACE VIEW NOTAS_INTEGRACION2_
(ID, CATEGORIA, FUNCION, ESTADO, FECHA, 
 P1, P2, P3, P4, P5, 
 P6, P7, P8, P9, P10, 
 P11, P12, P13, P14, P15, 
...
drop TABLE NOTAS_PARAMETRO cascade constraints;
...
INSERT INTO NOTAS_PARAMETRO (NOMBRE, VALOR) VALUES ('VIGENCIA', '2009');
COMMIT;
