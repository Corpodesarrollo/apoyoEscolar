...
<jsp:useBean id="filtro" class="siges.reporteLider.beans.FiltroBeanReporteLider" scope="session" /><jsp:setProperty name="filtro" property="*"/>
		...
		<!--
			...
			function guardar(tipo){
				if(validarForma(document.frmFiltro)){
					...
					document.frmFiltro.action='<c:url value="/reporteLider/filtroGuardar.jsp"/>';
					document.frmFiltro.submit();
				}	
			}
...
<%@include file="../mensaje.jsp" %>
		<font size='1'>
			...
			<table cellpadding="0" cellspacing="0" border="0" ALIGN="CENTER" width="100%" >
				<tr height="1">
					<td rowspan="2" width="420"><img src="../etc/img/tabs/lideres_1.gif" alt="Lideres"  height="26" border="0"><a href="javaScript:lanzar(2)"><img src="../etc/img/tabs/gobierno_escolar_0.gif" width="84"  height="26" border="0"></a><a href="javaScript:lanzar(3)"><img src="../etc/img/tabs/consolidado_lider_0.gif" width="84"  height="26" border="0"></a><a href="javaScript:lanzar(4)"><img src="../etc/img/tabs/consolidado_gobierno_0.gif" width="84"  height="26" border="0"></a></td>
				</tr>
			</table>
			<br>
							...
							<tr>
								...
								<td>
									<select name='institucion' onChange='cargaSede()' style='width:300px;'>
										<option value="-999">--seleccione uno--</option>
										<c:if test="${sessionScope.filtro.estadousu==1}">
							...
							<tr>
								...
								<td>
                                    <select name="vigencia" style='width:120px;'>
                                        ...
                                        <option value="<c:out value="${fila}"/>" <c:if test="${sessionScope.filtro.vigencia==fila}">SELECTED</c:if>> <c:out value="${fila}"/> </c:forEach>
                                     </select>
								</td>
							</tr>
