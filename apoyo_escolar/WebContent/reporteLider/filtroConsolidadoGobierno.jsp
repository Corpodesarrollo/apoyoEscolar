...
<jsp:useBean id="filtroConGob" class="siges.reporteLider.beans.FiltroBeanReporteConsolidadoGobierno" scope="session" /><jsp:setProperty name="filtroConGob" property="*"/>
		...
		<!--
			...
			function guardar(tipo){
				if(validarForma(document.frmFiltro)){
					...
					document.frmFiltro.action='<c:url value="/reporteLider/filtroGuardarConsolidadoGob.jsp"/>';
					document.frmFiltro.submit();
				}	
			}
...
<%@include file="../mensaje.jsp" %>
		<font size='1'>
			<form method="post" name="frmFiltro"  onSubmit=" return validarForma(frmFiltro)" action='<c:url value="/reporteLider/filtroGuardar.jsp"/>'>
			...
			<table cellpadding="0" cellspacing="0" border="0" ALIGN="CENTER" width="100%" >
				<tr height="1">
					<td rowspan="2" width="420"><a href="javaScript:lanzar(1)"><img src="../etc/img/tabs/lideres_0.gif" width="84"  height="26" border="0"></a><a href="javaScript:lanzar(2)"><img src="../etc/img/tabs/gobierno_escolar_0.gif" width="84"  height="26" border="0"></a><a href="javaScript:lanzar(3)"><img src="../etc/img/tabs/consolidado_lider_0.gif" alt="Consolidado Lideres"  height="26" border="0"></a><img src="../etc/img/tabs/consolidado_gobierno_1.gif" width="84"  height="26" border="0"></td>
				</tr>
			</table>
			<br>
						<table border="1" align="center" width="80%" cellpadding="0" cellspacing="0" bordercolor="#FFFFFF">
							...
							<tr>
								...
								<td>
									<select name='institucion' style='width:300px;'>
										<option value="-999">--seleccione uno--</option>
										<c:if test="${sessionScope.filtroConGob.estadousu==1}">
							...
							<tr>
								...
								<td>
                                    <select name="vigencia" style='width:120px;'>
                                        <option value='-999'>-- Seleccione una --</option>
                                        <c:forEach begin="2005" end="2007" var="fila" >
                                        <option value="<c:out value="${fila}"/>" <c:if test="${sessionScope.filtroConGob.vigencia==fila}">SELECTED</c:if>> <c:out value="${fila}"/> </c:forEach>
                                     </select>
								</td>
							</tr>
