...
<jsp:useBean id="filtroConLid" class="siges.reporteLider.beans.FiltroBeanReporteConsolidadoLider" scope="session" /><jsp:setProperty name="filtroConLid" property="*"/>
		...
		<!--
			...
			function guardar(tipo){
				if(validarForma(document.frmFiltro)){
					...
					document.frmFiltro.action='<c:url value="/reporteLider/filtroGuardarConsolidado.jsp"/>';
					document.frmFiltro.submit();
				}	
			}
...
<%@include file="../mensaje.jsp" %>
		<font size='1'>
			...
			<table cellpadding="0" cellspacing="0" border="0" ALIGN="CENTER" width="100%" >
				<tr height="1">
					<td rowspan="2" width="420"><a href="javaScript:lanzar(1)"><img src="../etc/img/tabs/lideres_0.gif" width="84"  height="26" border="0"></a><a href="javaScript:lanzar(2)"><img src="../etc/img/tabs/gobierno_escolar_0.gif" width="84"  height="26" border="0"></a><img src="../etc/img/tabs/consolidado_lider_1.gif" alt="Consolidado Lideres"  height="26" border="0"><a href="javaScript:lanzar(4)"><img src="../etc/img/tabs/consolidado_gobierno_0.gif" width="84"  height="26" border="0"></a></td>
				</tr>
			</table>
			<br>
							...
							<tr>
								...
								<td>
									<select name='institucion' style='width:300px;'>
										<option value="-999">--seleccione uno--</option>
										<c:if test="${sessionScope.filtroConLid.estadousu==1}">
							...
							<tr>
								...
								<td>
                                    <select name="vigencia" style='width:120px;'>
                                        ...
                                        <option value="<c:out value="${fila}"/>" <c:if test="${sessionScope.filtroConLid.vigencia==fila}">SELECTED</c:if>> <c:out value="${fila}"/> </c:forEach>
                                     </select>
								</td>
							</tr>
