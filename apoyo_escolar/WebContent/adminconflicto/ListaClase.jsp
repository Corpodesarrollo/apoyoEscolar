	...
	<font size="1">
		<form action="" method="post" name="frmLista" onSubmit="return validarForma(frmLista)">
			...
			<table>
				<tr>
					<td rowspan="2" width="600">
						...
						<img src='<c:url value="/etc/img/tabs/confclase_1.gif"/>' alt='Clases de Conflicto' height="26" border="0">
		  ...
		  <table border="0" align="center" width="95%" cellpadding="0" cellspacing="0">
			  ...
			  <c:if test="${empty requestScope.tclase}">
					<tr>
		  	...
		  	<c:if test="${!empty requestScope.tclase}">
			  	<tr>
					...
					<c:forEach begin="0" items="${requestScope.tclase}" var="fila" varStatus="st">
						<tr>
