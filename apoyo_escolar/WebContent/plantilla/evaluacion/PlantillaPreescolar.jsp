				...
				borrar_combo(combo_hijo); borrar_combo(combo_hijo2);
					<c:if test="${!empty requestScope.filtroMetodologia && !empty requestScope.filtroGrado2}">var Padres = new Array();
						<c:forEach begin="0" items="${requestScope.filtroMetodologia}" var="fila" varStatus="st">id_Hijos=new Array(); Hijos= new Array(); Sel_Hijos= new Array(); id_Padre= new Array(); var k=0;
							...
							<c:if test="${fila[0]==fila2[2] && (fila2[0]<=0 || fila2[0]==30 || fila2[0]==31 || fila2[0]==40 || fila2[0]==41)}">Sel_Hijos[k] = '<c:if test="${sessionScope.filtroPlantilla.grado== fila2[0]}">SELECTED</c:if>';id_Hijos[k] = '<c:out value="${fila2[0]}"/>'; Hijos[k] = '<c:out value="${fila2[1]}"/>'; id_Padre[k] = '<c:out value="${fila2[2]}"/>'; k++;</c:if>
							</c:forEach>Padres[<c:out value="${st.index}"/>] = new Padre(id_Hijos, Hijos, Sel_Hijos,id_Padre);</c:forEach>
...
<%@include file="../../mensaje.jsp"%>
	...
	<caption>Generar plantillas de Evaluación por Dimensiones</caption>
		<tr>		
...
<!--//////////////////-->		
	...
	<table cellpadding="0" cellspacing="0" border="0" ALIGN="CENTER" width="100%" >
		<tr height="1">
			...
			<td rowspan="2" width="588" bgcolor="#FFFFFF"><a href="javaScript:lanzar(1)"><img src="../../etc/img/tabs/Evaluacion_Asignaturas_0.gif" alt="Asignatura" width="84"  height="26" border="0"></a><a href="javaScript:lanzar(2)"><img src="../../etc/img/tabs/Evaluacion_Areas_0.gif" alt='-Area-' width="84"  height="26" border="0"></a><img src="../../etc/img/tabs/Evaluacion_Preescolar_1.gif" alt="Preescolar" width="84"  height="26" border="0"><a href="javaScript:lanzar(6)"><img src="../../etc/img/tabs/Recuperacion_0.gif" alt="Recuperacion" width="84"  height="26" border="0"></a><a href="javaScript:lanzar(10)"><img src='<c:url value="/etc/img/tabs/Evaluacion_Comportamiento_0.gif"/>' alt="Comportamiento" width="84"  height="26" border="0"></a></td>
		</tr>
	</table>
		<!-- FIN DE FICHAS A MOSTRAR AL USUARIO -->
								<TABLE width="100%" cellpadding="3" cellSpacing="0">
										<tr>
											...
											<td>
												<select name="metodologia" style='width:120px;' onChange='filtro3(document.frmNuevo.metodologia,document.frmNuevo.grado, document.frmNuevo.grupo);'>
											...
											<td><select name="grado" style='width:120px;' onChange='filtro2(document.frmNuevo.metodologia,document.frmNuevo.grado, document.frmNuevo.grupo);'><option value='-3'>-- Todos --</option></select></td>
											<th>Grupo:</th>
...
<script>
filtro3(document.frmNuevo.metodologia,document.frmNuevo.grado, document.frmNuevo.grupo);
</script>