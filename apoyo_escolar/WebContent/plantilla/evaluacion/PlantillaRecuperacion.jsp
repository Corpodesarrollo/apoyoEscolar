		...
		<!--
			...
			function guardar(tipo){
				if(validarForma(document.frmNuevo)){
					if(document.frmNuevo.periodo.selectedIndex>=document.frmNuevo.periodo2.selectedIndex){
					...
					document.frmNuevo.periodo2_.value=document.frmNuevo.periodo2.options[document.frmNuevo.periodo2.selectedIndex].text;
...
<c:import url="/mensaje.jsp"/>
	<form method="post" name="frmAjax" action='<c:url value="/plantilla/evaluacion/ControllerPlantillaAjax.do"/>'>
		<INPUT TYPE="hidden" NAME="tipo" VALUE='<c:out value="${propertiesVO.PLANTILLARECUPERACION}"/>'>
...
<!--//////////////////-->		
	...
	<input type="hidden" name="periodo2_" value='<c:out value="${sessionScope.filtroPlantilla.periodo2_}"/>'>
	...
	<table cellpadding="0" cellspacing="0" border="0" ALIGN="CENTER" width="100%" >
		<tr height="1">
			...
			<td rowspan="2" width="588" bgcolor="#FFFFFF"><a href="javaScript:lanzar(1)"><img src="../../etc/img/tabs/Evaluacion_Asignaturas_0.gif" alt="Asignatura" width="84"  height="26" border="0"></a><a href="javaScript:lanzar(2)"><img src="../../etc/img/tabs/Evaluacion_Areas_0.gif" alt="Asignatura" width="84"  height="26" border="0"></a><a href="javaScript:lanzar(3)"><img src="../../etc/img/tabs/Evaluacion_Preescolar_0.gif" alt="Preescolar" width="84"  height="26" border="0"></a><img src="../../etc/img/tabs/Recuperacion_1.gif" alt="Recuperacion" width="84"  height="26" border="0"><a href="javaScript:lanzar(10)"><img src='<c:url value="/etc/img/tabs/Evaluacion_Comportamiento_0.gif"/>' alt="Comportamiento" width="84"  height="26" border="0"></a></td>
		</tr>
								...
								<TABLE width="100%" cellpadding="3" cellSpacing="0">
										...
										<tr>
											...
											<th><span class="style2">*</span>Periodo Actual:</th>
											<td><select name="periodo2" style='width:100px;'>
												<option value='-3'>-- Seleccione uno --</option>
													<c:forEach begin="0" items="${requestScope.filtroPeriodo}" var="per">
														<option value="<c:out value="${per.codigo}"/>" <c:if test="${per.codigo==sessionScope.filtroPlantilla.periodo2}">selected</c:if>><c:out value="${per.nombre}"/></option>
													</c:forEach>
											</select></td>	
											<th><span class="style2">*</span>Periodo a Recuperar:</th>
											<td><select name="periodo" style='width:100px;'>
												<option value='-3'>-- Seleccione uno --</option>
													<c:forEach begin="0" items="${requestScope.filtroPeriodo}" var="per">
...
<script>filtro3(document.frmNuevo.metodologia,document.frmNuevo.grado, document.frmNuevo.grupo, document.frmNuevo.asignatura);
