...
<%@include file="../parametros.jsp"%>
	...
	<!--
		...
		function hacerValidaciones_frmRepEst(frmRepEst){

		}

		function lanzar(tipo){			
			document.frmRepEst.tipo.value=tipo;
			document.frmRepEst.submit();
		}

		function guardar(tipo){
			if(validarForma(document.frmRepEst)){
				document.frmRepEst.tipo.value=tipo;
				document.frmRepEst.cmd.value="Guardar";
				document.frmRepEst.submit();
			}
		}
	...
	<font size='1'>
		<form method="post" name="frmRepEst" onSubmit="return validarForma(frmRepEst)" action='<c:url value="/parametro/NuevoGuardar.jsp"/>'>
			...
			<table border="0" align="center" width="100%">
				...
				<tr>
		  		<td width="45%">
            <input class="boton" name="cmd1" type="button" value="Guardar" onClick="guardar(-9)">
			...
			<table border="0" align="center" width="80%" cellpadding="0" cellspacing="0">
				<tr>
					<td>Habilitado:</td>
					<td>
						<INPUT type='checkbox' name='g_parestadistico_' value="1" onClick='valorar(document.frmRepEst);' <c:if test="${sessionScope.parametros.g_parestadistico==1}">checked</c:if>>
					</td>
				</tr>
			</table>
		</form>
