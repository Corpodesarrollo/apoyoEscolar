...
<%@include file="../mensaje.jsp"%>	
	<font size="1">
		<FORM  METHOD="POST" name='frm' onSubmit=" return validarForma(frm)" action='<c:url value="/ruta/FiltroGuardar.jsp"/>'>
			...
			<INPUT TYPE="hidden" NAME="tipo"  VALUE='<c:out value="${pageScope.rutaParams.FICHA_NUTRICION_FILTRO}"/>'>
			...
			<caption>Nutrición - Filtro de busqueda</caption>
				<tr>
				  <td>
		...
		<table cellpadding="2" cellspacing="0" border="0" ALIGN="CENTER" width="100%" >
			<tr height="1">
				...
				<script>
				if(fichaNutricion==1){
					document.write('<img src="<c:url value="/etc/img/tabs/nutricion_1.gif"/>" alt=""  height="26" border="0">');
				}
				if(fichaGestacion==1){
					document.write('<a href="javaScript:lanzar(<c:out value="${pageScope.rutaParams.FICHA_GESTACION_FILTRO}"/>)"><img src="<c:url value="/etc/img/tabs/gestacion_0.gif"/>" alt=""  height="26" border="0"></a>');
				}
				</script></td>
			</tr>
