		...
		<!--
			...
			function guardar(tipo){
				if(validarForma(document.frmNuevo)){
					...
					if(confirm("Si desea abrir el grupo seleccionado haga click en aceptar")){
			...
			//sede, jornada,grado,grupo,metodologia
			function filtro2(combo_padre,combo_padre2,combo_hijo,combo_hijo2,combo_padre3){
...
<%@include file="../mensaje.jsp"%>
	...
	<table border="1" align="center" bordercolor="#FFFFFF" width="95%">
		<caption>Abrir Grupo para conflicto escolar</caption>
		<tr>
		  <td width="45%" bgcolor="#FFFFFF">
				<input class='boton' name="cmd1" type="button" value="Abrir Grupo" onClick="guardar(3)">
		  </td>
		</tr>
	</table>
<!--//////////////////-->		
	...
	<table cellpadding="0" cellspacing="0" border="0" ALIGN="CENTER" width="100%" >
		<tr height="1">
			...
			<td rowspan="2" width="235" bgcolor="#FFFFFF">
				<img src="../etc/img/tabs/abrir_grupo_ce_1.gif" border="0" height="26" alt='Abrir Grupo de conflicto escolar'>
			</td>
		</tr>
