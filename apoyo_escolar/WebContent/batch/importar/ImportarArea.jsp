...
<!--//////////////////-->		
	...
	<table cellpadding="0" cellspacing="0" border="0" ALIGN="CENTER" width="100%" >
		<tr height="1">
			...
			<td rowspan="2" width="588" bgcolor="#FFFFFF"><a href="javaScript:lanzar(4)"><img src="../../etc/img/tabs/logros_0.gif" alt="Asignatura" width="84"  height="26" border="0"></a><a href="javaScript:lanzar(5)"><img src="../../etc/img/tabs/descriptores_0.gif" alt="Asignatura" width="84"  height="26" border="0"></a><a href="javaScript:lanzar(1)"><img src="../../etc/img/tabs/Evaluacion_Asignaturas_0.gif" alt="Asignatura" width="84"  height="26" border="0"></a><img src="../../etc/img/tabs/Evaluacion_Areas_1.gif" alt='-Area-' width="84"  height="26" border="0"><a href="javaScript:lanzar(3)"><img src="../../etc/img/tabs/Evaluacion_Preescolar_0.gif" alt="Preescolar" width="84"  height="26" border="0"></a></td>
		</tr>
