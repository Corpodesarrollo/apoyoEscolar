...
<c:import url="/observacion/Nuevo.do"><c:param name="tipo" value="${paramsVO.FICHA_OBSERVACION_GRUPO}"/><c:param name="cmd" value="${paramsVO.CMD_NUEVO}"/></c:import>
<html>
<head>
...
<body onLoad="mensaje(document.getElementById('msg'));">
	<form action='<c:url value="/observacion/Save.jsp"/>' method="post" name="frmNuevo" onSubmit="return validarForma(frmNuevo)">
		...
		<table border="0" align="center" width="95%" cellpadding="2" cellspacing="0">
			<caption>OBSERVACIÓN POR GRUPO - REGISTRO</caption>
			<tr><td width="45%">
		...
		<table border="1" align="center" width="95%" cellpadding="0" cellspacing="0" bordercolor="gray">
			<tr>
				<th class="EncabezadoColumna">Grado - Grupo</th>
				<th class="EncabezadoColumna">Observación</th>
			</tr>
			<c:forEach begin="0" items="${requestScope.listaObservacionGrupo}" var="obs">
				<tr>
