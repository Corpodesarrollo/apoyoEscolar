...
<%@include file="../../mensaje.jsp"%>
	...
	<caption>Importación de Evaluación por Dimensiones</caption>
		<tr>
...
<!--//////////////////-->		
	...
	<table cellpadding="0" cellspacing="0" border="0" ALIGN="CENTER" width="100%" >
		<tr height="1">
			...
			<td rowspan="2" width="588" bgcolor="#FFFFFF"><a href="javaScript:lanzar(1)"><img src="../../etc/img/tabs/Evaluacion_Asignaturas_0.gif" alt="Asignatura" width="84"  height="26" border="0"></a><a href="javaScript:lanzar(2)"><img src="../../etc/img/tabs/Evaluacion_Areas_0.gif" alt='-Area-' width="84"  height="26" border="0"></a><img src="../../etc/img/tabs/Evaluacion_Preescolar_1.gif" alt="Preescolar" width="84"  height="26" border="0"><a href="javaScript:lanzar(10)"><img src='<c:url value="/etc/img/tabs/Evaluacion_Comportamiento_0.gif"/>' alt="Comportamiento" width="84"  height="26" border="0"></a></td>
		</tr>
								...
								<TABLE width="100%" cellpadding="3" cellSpacing="0">
				          			...
				          			<tr>
										<td colspan="6" align='center' valign="top">
										   <form name='frmGenerar' action='<c:url value="/${requestScope.plantilla}"/>' method='post' target='_blank'>
										           ...
										           <input type='hidden' name='aut' value='1'>Hubo inconsistencias en los datos de la plantilla.<br>Pulse en el Icono para descargar el archivo y ver los datos equivocados.<br>
										   </form>
									...
									<c:if test="${!empty requestScope.resultado}">
							          ...
							          <tr><td valign="top"><b>Dimensiones insertadas.</b></td><td><c:out value="${requestScope.resultado[2]}"/></td></tr>
							          <tr><td valign="top"><b>Dimensiones actualizadas.</b></td><td><c:out value="${requestScope.resultado[1]}"/></td></tr>
							          <tr><td valign="top"><b>Dimensiones eliminadas.</b></td><td><c:out value="${requestScope.resultado[3]}"/></td></tr>									
									</c:if>
								</TABLE>
</font>