...
<%@include file="../../mensaje.jsp"%>
	...
	<caption>Importación de Evaluación de Area</caption>
		<tr>
	...
	<table cellpadding="0" cellspacing="0" border="0" ALIGN="CENTER" width="100%" >
		<tr height="1">
			...
			<td rowspan="2" width="588" bgcolor="#FFFFFF">
				...
				<img src='<c:url value="/etc/img/tabs/Evaluacion_Areas_1.gif"/>' alt='-Area-' width="84"  height="26" border="0">
				...
				<a href="javaScript:lanzar(10)"><img src='<c:url value="/etc/img/tabs/Evaluacion_Comportamiento_0.gif"/>' alt="Comportamiento" width="84"  height="26" border="0"></a>
			</td>
		</tr>
				          ...
				          <tr>
									...
									<c:if test="${!empty requestScope.resultado}">
							          <tr><td colspan="6" align='center' valign="top"><b><span class="style2">Resultado de la importación de evaluación de Area.</span></b><br></td></tr>
									...
									<c:if test="${!empty requestScope.resultado2}">
							          <tr><td colspan="6" align='center' valign="top"><b><span class="style2">Resultado de la importación de asignación de descriptores.</span></b><br></td></tr>
							          <tr><td valign="top"><b>Estudiantes evaluados:</b></td><td><c:out value="${requestScope.resultado2[0]}"/></td></tr>
							          <tr><td valign="top"><b>Descriptores asignados:</b></td><td><c:out value="${requestScope.resultado2[2]}"/></td></tr>
							          <tr><td valign="top"><b>Descriptores actualizados:</b></td><td><c:out value="${requestScope.resultado2[1]}"/></td></tr>
							          <tr><td valign="top"><b>Descriptores eliminados:</b></td><td><c:out value="${requestScope.resultado2[3]}"/></td></tr>
									</c:if></font>
								</TABLE>
	</font>
