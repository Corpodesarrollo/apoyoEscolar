...
<%@include file="../../mensaje.jsp"%>
	...
	<caption>Importación de Logros</caption>
		<tr>
		  <td width="45%" bgcolor="#FFFFFF">
       <input name="cmd1" class='boton' type="button" value="Aceptar" onClick="guardar(document.frmNuevo.tipo.value)">
			</td>
		</tr>
	</table>
<!--//////////////////-->		
  ...
  <!-- FIN DE FICHAS A MOSTRAR AL USUARIO -->
				          ...
				          <tr><td valign="top"><b>Logros evaluados.</b></td><td><c:out value="${requestScope.resultado[0]}"/></td></tr>
				          <tr><td valign="top"><b>Logros insertados.</b></td><td><c:out value="${requestScope.resultado[2]}"/></td></tr>
				          <tr><td valign="top"><b>Logros actualizados.</b></td><td><c:out value="${requestScope.resultado[1]}"/></td></tr>
									</c:if>
								</TABLE>
	</font>
