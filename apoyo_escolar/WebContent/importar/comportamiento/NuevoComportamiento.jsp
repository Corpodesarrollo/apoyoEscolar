...
<c:import url="/mensaje.jsp"/>
	...
	<caption>Importación de Evaluación de Comportamiento</caption>
		<tr>
...
<!--//////////////////-->		
	...
	<c:if test="${requestScope.formaEstado==1}">
		...
		<TABLE width="100%" cellpadding="3" cellSpacing="0">
			<tr>
				...
				La plantilla de inconsistecias fue generada.<br>Pulse en el ícono para descargar el archivo.<br>				
	...
	<c:if test="${requestScope.formaEstado==2}">
		<TABLE width="50%" cellpadding="3" cellSpacing="0" border="0" align="left">
			<tr><td colspan="2" align='center' valign="top"><b><span class="style2">Resultado de la importación de evaluación de Comportamiento.</span></b><br></td></tr>
