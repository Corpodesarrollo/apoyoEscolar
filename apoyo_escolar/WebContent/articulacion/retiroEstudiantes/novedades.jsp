		...
		*/
		...
		var indice=document.frmNovedades.indice.value;
		 ...
		 if(opener.document.forms['frmNuevo'].elements['mot'].length){
		   ...
		   opener.document.forms['frmNuevo'].elements['mot'].value=document.frmNovedades.motivo.options[document.frmNovedades.motivo.selectedIndex].value;
		   opener.document.forms['frmNuevo'].elements['desc'].value=document.frmNovedades.noveDescripcion.value;
		   opener.document.forms['frmNuevo'].elements['band'].value=1;
		  }  
