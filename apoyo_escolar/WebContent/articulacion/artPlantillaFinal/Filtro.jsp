...
<body onLoad="mensaje(document.getElementById('msg'));">
	<form action='<c:url value="/articulacion/artPlantillaFinal/Save.jsp"/>' method="post" name="frmFiltro" onSubmit="return validarForma(frmFiltro)">
		...
		<table cellpadding="0" cellspacing="0" border="0" ALIGN="CENTER" width="100%" >
			<tr height="1">
				...
				<td rowspan="2" width="520">
					...
					<img src='<c:url value="/etc/img/tabs/art_generar_plantillas_1.gif"/>' alt="Plantilla" height="26" border="0">
		...
		<table border="0" align="center" width="95%" cellpadding="2" cellspacing="0">
			<caption>GENERACIÓN DE PLANTILLA DE EVALUACIÓN FINAL</caption>
			<tr><td width="45%">
		...
		<table border="0" align="center" width="95%" cellpadding="2" cellspacing="0">
	  	...
	  	<tr>
	  		...
	  		<td colspan="3">
					<select name="plaEspecialidad" style='width:250px;'>
						<option value="-99">-Seleccione uno-</option>
	...
	<c:if test="${sessionScope.plantillaFinalVO.formaEstado==1}">
		<TABLE width="100%" cellpadding="3" cellSpacing="0">
			<tr>
				<td align='center' valign="top">
				<c:out value="${sessionScope.plantillaFinalVO.plaMensaje}"/>
				<br>Pulse en el icono para descargar el archivo.<br>				
				<a href='<c:url value="/${sessionScope.plantillaFinalVO.plaUrl}"><c:param name="tipo" value="xls"/></c:url>'><img border=0 src='<c:url value="/etc/img/xls.gif"/>'></a>
	...
	<c:if test="${sessionScope.plantillaFinalVO.formaEstado==-1}">
		<TABLE width="100%" cellpadding="3" cellSpacing="0">
			<tr>
				<td align='center' valign="top"><span class="style2">Ocurrió un error intentando generar la plantilla</span><br>
				<c:out value="${sessionScope.plantillaFinalVO.plaMensaje}"/>
				</td>
			</tr>
		</TABLE>				
