...
<body onLoad="mensaje(document.getElementById('msg'));">
	<table width="100%" border="0" cellspacing="0" cellpadding="0">
		<tr><td width="100%" valign='top'>
			<div style="width:100%;height:165px;overflow:auto;vertical-align:top;background-color:#ffffff;"><c:import url="/articulacion/horarioArticulacion/Lista.do"/></div>
		</td></tr>
	</table>
	<form method="post" name="frmNuevo" onSubmit="return validarForma(frmNuevo)" action='<c:url value="/articulacion/horarioArticulacion/SaveHorario.jsp"/>'>
		...
		<c:if test="${sessionScope.horArtVO.formaEstado==1}">
					...
					<tr>
						...
						<c:forEach begin="0" items="${clase.dia}" var="dia">
							<td align="center" class='<c:out value="${dia.style}"/>'>
								<span class="c2"><c:out value="${dia.especialidad}"/></span><br>
			...
			<tr><td align="center"><span class="c2"> --Especialidad-- </span></td></tr>
