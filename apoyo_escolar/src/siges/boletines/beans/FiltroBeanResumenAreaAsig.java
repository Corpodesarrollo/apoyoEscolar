...
/**
 * Nombre: FiltroBeanResumenAreas.java <BR>
 * Descripcinn: Contiene los datos referentes al formulario de peticinn del
 * Reporte<BR>
 * Funciones de la pngina: Almacenar temporalmente los datos del formulario de
 * peticinn del reporte a generar <BR>
...
public class FiltroBeanResumenAreaAsig implements Serializable, Cloneable {
