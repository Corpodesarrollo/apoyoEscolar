...
public class ParamsVO extends Params{
	...
	public static final String REP_MODULO = "3";
	
	public static final String REP_MODULO_CERT = "4";
	public static final String REP_MODULO_LIBRO = "8";
	...
	public static final int TIPO_REPORTE_ASIG = 1;
	public static final int TIPO_REPORTE_DIM = 2;
	
	
	public static final String TIPO_REPORTE_1_ = "Comparativo por Asignaturas";
	public static final String TIPO_REPORTE_2_ = "Comparativo por Asignatura y Grupo";
	public static final String TIPO_REPORTE_3_ = "Comparativo por Asignatura y Periodo";
