...
public class EvaluacionEstudiante extends Vo{
	 ...
	 */
	public double getEvalNota() {
		return evalNota;
	}
	/**
	 * @param evalNota The evalNota to set.
	 */
	public void setEvalNota(double evalNota) {
	...
	public String getEvalNota_() {
		return evalNota_;
	}
	public void setEvalNota_(String evalNota) {
		evalNota_ = evalNota;
	}
}
