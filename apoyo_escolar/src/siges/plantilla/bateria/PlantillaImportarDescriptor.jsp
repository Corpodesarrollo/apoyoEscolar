		...
		<!--
			...
			function hacerValidaciones_frmNuevo(forma){
				...
				if(forma.plantillaAsignatura.selectedIndex>0 && forma.plantillaDocente){
					validarLista(forma.plantillaDocente,"- Una vez que seleccione una area debe escoger el docente en particular",1)
				}
			}
...
<c:import url="/mensaje.jsp"/>
	<form method="post" name="frmAjax" action='<c:url value="/plantilla/bateria/ControllerPlantillaAjax.do"/>'>
		<INPUT TYPE="hidden" NAME="tipo" VALUE='<c:out value="${propertiesVO.TIPOBATERIADESCRIPTOR}"/>'>
	...
	<caption>Generar plantillas de Descriptores</caption>
		<tr>
...
<!--//////////////////-->		
	...
	<input type="hidden" name="plantillaMetodologia_" value='<c:out value="${sessionScope.logros.plantillaMetodologia_}"/>'>
	...
	<table cellpadding="0" cellspacing="0" border="0" align="CENTER" width="100%" >
  		<tr height="1">
  				...
  				<td rowspan="2" width="588" bgcolor="#FFFFFF"><a href="javaScript:lanzar(4)"><img src="../../etc/img/tabs/logros_0.gif" alt="Asignatura" width="84"  height="26" border="0"></a><img src="../../etc/img/tabs/descriptores_1.gif" alt="Asignatura" width="84"  height="26" border="0"></td>
 				</tr>
 		</table>
	<!-- FIN DE FICHAS A MOSTRAR AL USUARIO -->
								<TABLE width="100%" cellpadding="3" cellSpacing="0">
										<tr>
											...
											<td>
												<select name="plantillaMetodologia" style='width:120px;' onChange='filtro2(document.frmNuevo.plantillaMetodologia,document.frmNuevo.plantillaGrado,document.frmNuevo.plantillaAsignatura)'>
													...
													<c:forEach begin="0" items="${requestScope.filtroMetodologia}" var="met">
														<option value="<c:out value="${met[0]}"/>" <c:if test="${met[0]==sessionScope.logros.plantillaMetodologia}">selected</c:if>><c:out value="${met[1]}"/></option>
													</c:forEach>
												</select>
											</td>	
											<th>Grado:</th>
										...
										<tr>	
											<th>Area:</th>
											<td><select name="plantillaAsignatura" style='width:120px;' onchange="javaScript:ajaxDocente()"><option value='-99'>-- Todos --</option></select></td>	
										</tr>
									...
									<c:if test="${!empty requestScope.plantilla && requestScope.plantilla!='--' && requestScope.plantilla!='0'}">
									<tr>
