package siges.reporteLider.dao;
 ...
 * 
 */
public class reporteLiderDAO extends Dao {
    ...
    public reporteLiderDAO(Cursor cur){
        super(cur);
        bytes=null;
	...
	public boolean isEmpty(FiltroBeanReporteLider filtroBeanReporteLider) throws Exception{
		Connection con=null;
		PreparedStatement pst=null;
		ResultSet rs=null;
		int posicion=1;
		try{
			...
			posicion=1;
			pst.setLong(posicion++,filtroBeanReporteLider.getLocalidad().longValue());
			pst.setLong(posicion++,filtroBeanReporteLider.getInstitucion().longValue());
			pst.setLong(posicion++,filtroBeanReporteLider.getSede().longValue());
			pst.setLong(posicion++,filtroBeanReporteLider.getSede().longValue());
			pst.setLong(posicion++,filtroBeanReporteLider.getJornada().longValue());
			pst.setLong(posicion++,filtroBeanReporteLider.getJornada().longValue());
			pst.setLong(posicion++,-999);
			pst.setLong(posicion++,-999);
			pst.setLong(posicion++,filtroBeanReporteLider.getTipoLider().longValue());
			pst.setLong(posicion++,filtroBeanReporteLider.getTipoLider().longValue());
			rs=pst.executeQuery();
	...
	public boolean isEmptyGob(FiltroBeanReporteGobierno filtroBeanReporteGobierno) throws Exception{
		Connection con=null;
		PreparedStatement pst=null;
		ResultSet rs=null;
		int posicion=1;
		try{
  			con=cursor.getConnection();								
			pst=con.prepareStatement(rb3.getString("isEmptyGob"));
			posicion=1;
			pst.setLong(posicion++,filtroBeanReporteGobierno.getLocalidad().longValue());
			pst.setLong(posicion++,filtroBeanReporteGobierno.getInstitucion().longValue());
			pst.setLong(posicion++,filtroBeanReporteGobierno.getSede().longValue());
			pst.setLong(posicion++,filtroBeanReporteGobierno.getSede().longValue());
			pst.setLong(posicion++,filtroBeanReporteGobierno.getJornada().longValue());
			pst.setLong(posicion++,filtroBeanReporteGobierno.getJornada().longValue());
			pst.setLong(posicion++,filtroBeanReporteGobierno.getTipoLider().longValue());
			pst.setLong(posicion++,filtroBeanReporteGobierno.getTipoLider().longValue());
			pst.setLong(posicion++,filtroBeanReporteGobierno.getLocalidad().longValue());
			pst.setLong(posicion++,filtroBeanReporteGobierno.getInstitucion().longValue());
			pst.setLong(posicion++,filtroBeanReporteGobierno.getSede().longValue());
	...
	public boolean isEmptyConLid(FiltroBeanReporteConsolidadoLider filtroBeanReporteConsolidadoLider) throws Exception{
		Connection con=null;
		PreparedStatement pst=null;
		ResultSet rs=null;
		int posicion=1;
		try{
  			con=cursor.getConnection();								
			pst=con.prepareStatement(rb3.getString("isEmptyConLid"));
			posicion=1;
			pst.setLong(posicion++,filtroBeanReporteConsolidadoLider.getLocalidad().longValue());
			pst.setLong(posicion++,filtroBeanReporteConsolidadoLider.getInstitucion().longValue());
			pst.setLong(posicion++,filtroBeanReporteConsolidadoLider.getInstitucion().longValue());
			pst.setLong(posicion++,filtroBeanReporteConsolidadoLider.getTipoLider().longValue());
			pst.setLong(posicion++,filtroBeanReporteConsolidadoLider.getTipoLider().longValue());
			pst.setLong(posicion++,filtroBeanReporteConsolidadoLider.getLocalidad().longValue());
			pst.setLong(posicion++,filtroBeanReporteConsolidadoLider.getInstitucion().longValue());
			pst.setLong(posicion++,filtroBeanReporteConsolidadoLider.getInstitucion().longValue());
	...
	public boolean isEmptyConGob(FiltroBeanReporteConsolidadoGobierno filtroBeanReporteConsolidadoGobierno) throws Exception{
		Connection con=null;
		PreparedStatement pst=null;
		ResultSet rs=null;
		int posicion=1;
		try{
  			con=cursor.getConnection();								
			pst=con.prepareStatement(rb3.getString("isEmptyConGob"));
			posicion=1;
			pst.setLong(posicion++,filtroBeanReporteConsolidadoGobierno.getLocalidad().longValue());
			pst.setLong(posicion++,filtroBeanReporteConsolidadoGobierno.getInstitucion().longValue());
			pst.setLong(posicion++,filtroBeanReporteConsolidadoGobierno.getInstitucion().longValue());
			pst.setLong(posicion++,filtroBeanReporteConsolidadoGobierno.getTipoLider().longValue());
			pst.setLong(posicion++,filtroBeanReporteConsolidadoGobierno.getTipoLider().longValue());
			pst.setLong(posicion++,filtroBeanReporteConsolidadoGobierno.getLocalidad().longValue());
			pst.setLong(posicion++,filtroBeanReporteConsolidadoGobierno.getInstitucion().longValue());
			pst.setLong(posicion++,filtroBeanReporteConsolidadoGobierno.getInstitucion().longValue());
