...
public class FiltroBeanEvaluacionAsignaturaGrupo implements Serializable, Cloneable{
...
/**
 * asigna el campo evaluaciones
 *	@param String s
 */
	public void setEvaluaciones(String[] s){
		this.evaluaciones=s;
		}
	
/**
 * retorna el campo evaluaciones
 *	@return String
 */
