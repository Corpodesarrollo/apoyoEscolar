...
/**
*	Nombre: FiltroBeanEvaluacionTipoDescriptor.java	<BR>
...
public class FiltroBeanEvaluacionTipoDescriptor implements Serializable, Cloneable{
   ...
   private String[]tipodescriptores;
...
/**
 * asigna el campo tipodescriptores
 *	@param String s
 */
	public void setTipodescriptores(String[] s){
		this.tipodescriptores=s;
		}
	
/**
 * retorna el campo tipodescriptores
 *	@return String
 */
	public String[] getTipodescriptores(){
		return tipodescriptores;
	}
