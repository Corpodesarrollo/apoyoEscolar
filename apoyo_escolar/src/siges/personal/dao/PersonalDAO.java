...
public class PersonalDAO extends Dao {
	...
	public Carga asignarFijarDocente(String id, String id2, String id3,
		...
		try {
			...
			setMensaje("Error intentando asignar informaci贸n de Docente-Grado-Asignatura. Posible problema: ");
	...
	public Collection getLaborales(Personal p) {
		...
		try {
			...
			setMensaje("Error intentando obtener informaci贸n laboral. Posible problema: ");
			switch (sqle.getErrorCode()) {
			default:
				setMensaje(sqle.getMessage().replace('\'', '`')
						.replace('"', 'n'));
	...
	public Collection getAsistencias(String tipo, Personal p) {
		...
		try {
			...
			setMensaje("Error intentando obtener informaci贸n acadnmica. Posible problema: ");
			switch (sqle.getErrorCode()) {
			default:
				setMensaje(sqle.getMessage().replace('\'', '`')
						.replace('"', 'n'));
	...
	public Personal asignarPersonal(String id, String id2) {
		...
		try {
			...
			setMensaje("Error intentando asignar informaci贸n de personal. Posible problema: ");
			switch (sqle.getErrorCode()) {
			default:
				setMensaje(sqle.getMessage().replace('\'', '`')
						.replace('"', 'n'));
...
//			System.out.println("tipo " + tipo);
	...
	public boolean actualizar(Salud s, String[] valores) {
		...
		try {
			...
			setMensaje("Error SQL intentando ingresar informaci贸n familiar. Posible problema: ");
			switch (sqle.getErrorCode()) {
			default:
				setMensaje(sqle.getMessage().replace('\'', '`')
						.replace('"', 'n'));
	...
	public boolean actualizar(LaboralVO l) {
		...
		try {
			...
			setMensaje("Error intentando actualizar informaci贸n laboral.("
	...
	public boolean actualizar(AsistenciaVO a) {
		...
		try {
			...
			setMensaje("Error intentando actualizar informaci贸n de asistencia.("
					+ sqle.getErrorCode() + ") Posible problema: ");
			switch (sqle.getErrorCode()) {
			default:
				setMensaje(sqle.getMessage().replace('\'', '`')
	...
	public boolean actualizar(Convivencia c) {
		...
		try {
			...
			setMensaje("Error intentando actualizar informaci贸n de convivencia.("
					+ sqle.getErrorCode() + ") Posible problema: ");
			switch (sqle.getErrorCode()) {
			default:
				setMensaje(sqle.getMessage().replace('\'', '`')
	...
	public synchronized boolean insertar(LaboralVO l) {
		...
		try {
			...
			setMensaje("Error intentando ingresar informaci贸n laboral.("
					+ sqle.getErrorCode() + ") Posible problema: ");
			switch (sqle.getErrorCode()) {
			default:
				setMensaje(sqle.getMessage().replace('\'', '`')
	...
	public boolean insertar(Salud s) {
		...
		try {
			...
			setMensaje("Error SQL intentando ingresar informaci贸n de salud. Posible problema: ");
			switch (sqle.getErrorCode()) {
			default:
				setMensaje(sqle.getMessage().replace('\'', '`')
						.replace('"', 'n'));
	...
	public/* synchronized */boolean insertar(AsistenciaVO a) {
		...
		try {
			...
			setMensaje("Error intentando ingresar informaci贸n de asistencia.("
					+ sqle.getErrorCode() + ") Posible problema: ");
			switch (sqle.getErrorCode()) {
			default:
				setMensaje(sqle.getMessage().replace('\'', '`')
	...
	public boolean insertar(Convivencia c) {
		...
		try {
			...
			setMensaje("Error intentando ingresar informaci贸n de convivencia.("
					+ sqle.getErrorCode() + ") Posible problema: ");
			switch (sqle.getErrorCode()) {
			default:
				setMensaje(sqle.getMessage().replace('\'', '`')
	...
	public boolean insertarSedeJornada(Personal p, long inst, String[] jornada) {
		...
		try {
			...
			setMensaje("Error SQL intentando ingresar informaci贸n de sede y jornada. Posible problema: ");
	...
	public Collection getFormaciones(Personal p) {
		...
		try {
			...
			setMensaje("Error intentando obtener informaci贸n formacinn. Posible problema: ");
			switch (sqle.getErrorCode()) {
			default:
				setMensaje(sqle.getMessage().replace('\'', '`')
						.replace('"', 'n'));
	...
	public synchronized boolean insertar(FormacionVO f) {
		...
		try {
			...
			setMensaje("Error intentando ingresar informaci贸n de formacinn.("
					+ sqle.getErrorCode() + ") Posible problema: ");
			switch (sqle.getErrorCode()) {
			default:
				setMensaje(sqle.getMessage().replace('\'', '`')
	...
	public boolean insertarFijarDocente(Carga r, Login l) {
		...
		try {
			...
			setMensaje("Error SQL intentando ingresar informaci贸n de Docente-Grado-Asignatura. Posible problema: ");
			switch (sqle.getErrorCode()) {
			default:
				setMensaje(sqle.getMessage().replace('\'', '`')
						.replace('"', 'n'));
	...
	public List consultarHrDocenteXGradoNaranja(long idDocente, long asignatura, int vigencia, long jerCodigoGrado) {
		...
		try {
			...
			setMensaje("[consultarHrDocenteXGradoNaranja]: No se puede establecer conexi髇 con la base de datos: ");
			return null;
			...
			setMensaje("[consultarHrDocenteXGradoNaranja]: Error intentando ingresar informaci髇 laboral.("+ sqle.getErrorCode() + ") Posible problema: ");
			switch (sqle.getErrorCode()) {
			default:
	...
	public List consultarHrDocenteXGradoGrupoAzul(long idDocente, long asignatura, int vigencia, long jerCodigoGrado, long grupo) {
		...
		try {
			...
			setMensaje("[consultarHrDocenteXGradoGrupoAzul]: No se puede establecer conexi髇 con la base de datos: ");
			return null;
			...
			setMensaje("[consultarHrDocenteXGradoGrupoAzul]: Error intentando ingresar informaci髇 laboral.("+ sqle.getErrorCode() + ") Posible problema: ");
			switch (sqle.getErrorCode()) {
			default:
				setMensaje(sqle.getMessage().replace('\'', '`').replace('"', 'n'));
			}
	...
	public List consultarHrDocenteXGradoAzul(long idDocente, long asignatura, int vigencia, long jerCodigoGrado) {
		...
		try {
			...
			setMensaje("[consultarHrDocenteXGradoAzul]: No se puede establecer conexi髇 con la base de datos: ");
			return null;
			...
			setMensaje("[consultarHrDocenteXGradoAzul]: Error intentando ingresar informaci髇 laboral.("+ sqle.getErrorCode() + ") Posible problema: ");
			switch (sqle.getErrorCode()) {
			default:
				setMensaje(sqle.getMessage().replace('\'', '`').replace('"', 'n'));
			}
	...
	public boolean insertarHrDocenteXGradoGrupoAzul(long jerCodigoGrado, long idDocente, long asignatura , long grupo, int vigencia, int hora) {
		...
		try {
			...
			System.out.println("[PersonalDAO]-[insertarHrDocenteXGradoGrupoAzul]: Registro exitoso de informaci髇 en la tabla ROT_DOC_ASIG_GRADO_GRUPO ==> REG [ROTDAGGJERGRADO: "+jerCodigoGrado+", ROTDAGGDOCENTE: "+idDocente+", ROTDAGGASIGNATURA: "+asignatura+",ROTDAGGGRUPO: "+grupo+",ROTDAGGVIGENCIA: "+vigencia+",ROTDAGGIH: "+hora+"]");
		
		} catch (InternalErrorException in) {
			in.printStackTrace();
			setMensaje("[insertarHrDocenteXGradoGrupoAzul]: NO se puede estabecer conexi髇 con la base de datos: ");
			return false;
		} catch (SQLException sqle) {
			sqle.printStackTrace();
			try {
			...
			setMensaje("[insertarHrDocenteXGradoGrupoAzul]: Error intentando ingresar informaci髇 laboral.("+ sqle.getErrorCode() + ") Posible problema: ");
			switch (sqle.getErrorCode()) {
			default:
				setMensaje(sqle.getMessage().replace('\'', '`').replace('"', 'n'));
			}
	...
	public boolean actualizarHrDocenteXGradoGrupoAzul(long jerCodigoGrado, long idDocente, long asignatura , long grupo, int vigencia, int hora) {
		...
		try {
			...
			System.out.println("[PersonalDAO]-[actualizarHrDocenteXGradoGrupoAzul]: Actualizaci髇 exitosa de informaci髇 en la tabla ROT_DOC_ASIG_GRADO_GRUPO ==> REG [ROTDAGGJERGRADO: "+jerCodigoGrado+", ROTDAGGDOCENTE: "+idDocente+", ROTDAGGASIGNATURA: "+asignatura+",ROTDAGGGRUPO: "+grupo+",ROTDAGGVIGENCIA: "+vigencia+",ROTDAGGIH: "+hora+"]");
		
		} catch (InternalErrorException in) {
			in.printStackTrace();
			setMensaje("[actualizarHrDocenteXGradoGrupoAzul]: NO se puede estabecer conexi髇 con la base de datos: ");
			return false;
		} catch (SQLException sqle) {
			sqle.printStackTrace();
			try {
			...
			setMensaje("[actualizarHrDocenteXGradoGrupoAzul]: Error intentando ingresar informaci髇 laboral.("+ sqle.getErrorCode() + ") Posible problema: ");
			switch (sqle.getErrorCode()) {
			default:
				setMensaje(sqle.getMessage().replace('\'', '`').replace('"', 'n'));
			}
	...
	public boolean eliminarHrDocenteXGradoGrupoAzul(long jerCodigoGrado, long idDocente, long asignatura , long grupo, int vigencia) {
		...
		try {
			...
			setMensaje("[eliminarHrDocenteXGradoGrupoAzul]: Error intentando ingresar informaci贸n laboral.("+ sqle.getErrorCode() + ") Posible problema: ");
			switch (sqle.getErrorCode()) {
			default:
				setMensaje(sqle.getMessage().replace('\'', '`').replace('"', 'n'));
			}
