...
public class FiltroPersonal implements Cloneable{
   private String sede;//1
   private String jornada;//2
   private String insttitucion;//2
 ...
 */
	...
	public String getTipoPersona() {
		return tipoPersona !=null ? tipoPersona : "";
	}
	/**
...
public String getInsttitucion() {
	return insttitucion;
}

public void setInsttitucion(String insttitucion) {
	this.insttitucion = insttitucion;
}	
}