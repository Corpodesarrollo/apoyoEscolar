...
public class NivelEvaluacionVO  extends Vo{
	...
	public long getG_nivevaestado() {
		return G_nivevaestado;
	}
	public void setG_nivevaestado(long g_nivevaestado) {
		G_nivevaestado = g_nivevaestado;
	}
