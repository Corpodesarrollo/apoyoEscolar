...
public class RepResultadosAca__ extends Thread {
	...
	public RepResultadosAca__(Cursor c, String cont, String p, String p1,
			String p2, File reporte1_1_, File reporte1_2_, File reporte1_con_,
	...
	public void run() {
		...
		try {
			...
			while (true) {
				...
				// }
				// System.out
				// .println("REP COMPARATIVOS: ENTRO A REVISAR SOLICITUDES, PARA ATENDERLAS");
