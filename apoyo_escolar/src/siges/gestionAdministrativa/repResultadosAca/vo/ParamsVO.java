...
public class ParamsVO extends Params{
	...
	public static final int FICHA_COMPRENDIMIENTOACADEMICO = 2;
	public static final int FICHA_REPORTES_COLEGIO = 3;
	public static final int FICHA_DEFAULT = FICHA_REPORTES;
	
	public static final String REP_MODULO = "26";
	public static final String REP_MODULO_COMPVIGENCIAANT= "27";
	...
	public static final int CMD_AJAX_PER = 9;
	...
	public static final int TIPO_REPORTE_1 = 7;
	public static final int TIPO_REPORTE_2 = 8;
	public static final int TIPO_REPORTE_3 = 9;
	...
	public static final int ESTADO_REPORTE_REVISADO = 3;
	
	
	public static int getFICHA_DEFAULT() {
		return FICHA_DEFAULT;
	}
	public   int getESTADO_REPORTE_REVISADO() {
		return FICHA_REPORTES;
	}
	public int getFICHA_REPORTES_COLEGIO(){
		return FICHA_REPORTES_COLEGIO;
	}
	public   int getFICHA_REPORTES() {
		return FICHA_REPORTES;
	}
	public   int getFICHA_COMPRENDIMIENTOACADEMICO(){
		return FICHA_COMPRENDIMIENTOACADEMICO;
	}
