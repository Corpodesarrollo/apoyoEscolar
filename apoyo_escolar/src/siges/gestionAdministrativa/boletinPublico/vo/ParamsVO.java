...
public class ParamsVO extends Params{
	...
	public static final int FICHA_PLANTILLA_BOLETIN = -7;
	...
	public static final int BOLETIN_ASIG = 1;
	public static final int BOLETIN_DIM = 2;
	...
	public   int getCMD_TRAER_CONSTANCIA() {
		return CMD_TRAER_CONSTANCIA;
	}
	public   int getCMD_ENVIAR_CONSTANCIA() {
		return CMD_ENVIAR_CONSTANCIA;
	}
	...
	public   int getBOLETIN_ASIG() {
		return BOLETIN_ASIG;
	}
	public   int getBOLETIN_DIM() {
		return BOLETIN_DIM;
	}
