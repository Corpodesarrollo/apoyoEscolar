package siges.comision.beans;

import java.io.*;

/**
*	Nombre:	FiltroBeanCom<br>
*	Descripcinn:	Bean de Comisinn<br>
*	Funciones de la pngina:	Subir al Bean los datos de Comisinn de Evaluacinn<br>
*	Entidades afectadas:	Tablas maestras en modo de solo lectura<br>
*	Fecha de modificacinn:	20/07/2005 <br>
*	@author Latined <br>
*	@version v 1.0 <br>
*/
public class FiltroBeanCom implements Serializable, Cloneable{
