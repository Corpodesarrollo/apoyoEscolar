...
public class TipoEvalVO{
	...
	/**
	 * @return the eval_min_aprob
	 */
	public double getEval_min_aprob() {
		return eval_min_aprob;
	}
	/**
	 * @param eval_min_aprob the eval_min_aprob to set
	 */
	public void setEval_min_aprob(double eval_min_aprob) {
		this.eval_min_aprob = eval_min_aprob;
	}
