 ...
 * 
 */
package poa.aprobacionActividades.vo;
...
public class ColegioPoaVO extends Vo{
	...
	private String colNombreEstado;
	private String colFechaEstado;
	private String colObservacion;
	...
	/**
	 * @return Return the colFechaEstado.
	 */
	public String getColFechaEstado() {
		return colFechaEstado;
	}
	/**
	 * @param colFechaEstado The colFechaEstado to set.
	 */
	public void setColFechaEstado(String colFechaEstado) {
		this.colFechaEstado = colFechaEstado;
	}
	/**
	 * @return Return the colNombreEstado.
	 */
	public String getColNombreEstado() {
		return colNombreEstado;
	}
	/**
	 * @param colNombreEstado The colNombreEstado to set.
	 */
	public void setColNombreEstado(String colNombreEstado) {
		this.colNombreEstado = colNombreEstado;
	}
	/**
	...
	/**
	 * @return Return the colObservacion.
	 */
	public String getColObservacion() {
		return colObservacion;
	}
	/**
	 * @param colObservacion The colObservacion to set.
	 */
	public void setColObservacion(String colObservacion) {
		this.colObservacion = colObservacion;
	}
}
