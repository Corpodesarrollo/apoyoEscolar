...
public class ParamsVO  extends Params{
	...
	public static final int FICHA_ACTIVIDAD=2;
	public static final int FICHA_ACTIVIDAD_SIN=3;
	...
	public static final int CMD_APROBAR_CAMBIO=20;
	public static final int CMD_RECHAZAR_CAMBIO=21;
	public static final int CMD_REALIZAR_CAMBIO=22;
	...
	public static final int CMD_AJAX_TIPOGASTO=18;

	
	public int getCMD_AJAX_TIPOGASTO() {
		return CMD_AJAX_TIPOGASTO;
	}
	...
	public  int getCMD_APROBAR_CAMBIO() {
		return CMD_APROBAR_CAMBIO;
	}
	public  int getCMD_RECHAZAR_CAMBIO() {
		return CMD_RECHAZAR_CAMBIO;
	}
	public  int getCMD_REALIZAR_CAMBIO() {
		return CMD_REALIZAR_CAMBIO;
	}
}
