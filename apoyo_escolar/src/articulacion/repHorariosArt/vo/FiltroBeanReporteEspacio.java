...
public class FiltroBeanReporteEspacio implements Serializable, Cloneable{
	 ...
	 */
	public void setEspacio(Long docente) {
		this.espacio = docente;
	}
	...
	/**
	 * @param sede The tipoEspacio to set.
	 */
	public void setTipoEspacio(Long tipoEsp) {
		this.tipoEspacio = tipoEsp;
	}
	
	/**
	 * @return Returns the tipoEspacio.
	 */
	public Long getTipoEspacio() {
		return tipoEspacio;
	}
