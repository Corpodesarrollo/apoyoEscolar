...
public class FiltroBeanReporteGrupos implements Serializable, Cloneable{
	 ...
	 private Long institucion; 
	   ...
	   /**
		 ...
		 * @return Returns the filEspacialidad.
		 */
		public Long getFilGrupo() {
			return filGrupo;
		}
		/**
		 * @param filPerVigenciaArt The filPerVigenciaArt to set.
		 */
		public void setFilGrupo(Long filtGru) {
			this.filGrupo = filtGru;
		} 
