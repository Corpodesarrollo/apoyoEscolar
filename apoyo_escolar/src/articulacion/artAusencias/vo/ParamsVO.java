...
public class ParamsVO extends Params{
	...
	public static final int CMD_GUARDA_MOTIVO=3;
	public static final int CMD_LISTA_MOTIVO=4;
	...
	public int getCMD_GUARDA_MOTIVO() {
		return CMD_GUARDA_MOTIVO;
	}
	public int getCMD_LISTA_MOTIVO() {
		return CMD_LISTA_MOTIVO;
	}
