...
public class FiltroBeanReporteEspacio implements Serializable, Cloneable{
   ...
   private Integer tipoEspacioFisico;
...
/**
 * @return Returns the espacioFisico.
 */
public Integer getEspacioFisico() {
...
/**
 * @param espacioFisico The espacioFisico to set.
 */
public void setEspacioFisico(Integer espacioFisico) {
...
/**
 * @return Returns the tipoEspacioFisico.
 */
public Integer getTipoEspacioFisico() {
...
/**
 * @param tipoEspacioFisico The tipoEspacioFisico to set.
 */
public void setTipoEspacioFisico(Integer tipoEspacioFisico) {
