 ...
 * @version 1.2
 */
public class Encuesta4VO extends Vo{
	...
	private int filOpcion=-99;
	private int filAsignatura=-99;
	...
	public int getFilOpcion() {
		return filOpcion;
	}

	public void setFilOpcion(int opc) {
		this.filOpcion= opc;
	}
	...
	public void setFilAsignatura(int asig) {
