package articulacion.plantillaArticulacion.vo.plantilla;
...
public class ExcelVO {
	...
	//public static final int codigoEscala=i++;
	...
	public static final int nomEspecialidad=i++;
	public static final int nomSemestre=i++;
	public static final int nomNivelado=i++;
	...
	static public void Cargar() {
             ...
             plantilla[nomEspecialidad][FIL]=7;
             plantilla[nomEspecialidad][COL]=6;
             plantilla[nomSemestre][FIL]=7;
             plantilla[nomSemestre][COL]=7;
             plantilla[nomNivelado][FIL]=7;
             plantilla[nomNivelado][COL]=8;
	}
