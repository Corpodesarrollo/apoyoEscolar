 ...
 * @version 1.1
 */
public class FiltroLideresVO  extends Vo{
	...
	/**
	 * @return Return the filNombreRol.
	 */
	public String getFilNombreRol() {
		return filNombreRol;
	}
	/**
	 * @param filNombreRol The filNombreRol to set.
	 */
	public void setFilNombreRol(String filNombreRol) {
		this.filNombreRol = filNombreRol;
	}
	/**
