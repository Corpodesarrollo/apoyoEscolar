...
public class EnviarJMSReporte {

	// It created initial context to access WebLogic Naming service
	public final static String JNDI_FACTORY = "weblogic.jndi.WLInitialContextFactory";
	// JNDI name of WebLogic connection factory
	public static String CONNECTION_FACTORY = "ReportesConnectionFactory";
	// JNDI name of WebLogic QUEUE
	public static String QUEUE = "ReportesQueue";

	private static int port = 7804;
	...
	public static void enviarMensaje(String mensaje) {
		...
		// The hostname and port of WebLogic server where JMS Server is
		// configured
		// int port = 7001;
		...
		try {
			// Initial Context
//			InitialContext namingContext = getInitialContext("t3://" + host + ":" + port);//Ojo que es local !!!
			InitialContext namingContext = new InitialContext();
			// Queue
			Queue queue = (Queue) namingContext.lookup(QUEUE);

			// Connection Factory
			QueueConnectionFactory queueConnectionFactory = (QueueConnectionFactory) namingContext
